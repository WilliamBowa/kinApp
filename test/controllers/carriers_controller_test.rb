...
class CarriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrier" do
    assert_difference('Carrier.count') do
      post carriers_url, params: { carrier: { description: @carrier.description, extension: @carrier.extension, name: @carrier.name } }
    end
  ...
  test "should update carrier" do
    patch carrier_url(@carrier), params: { carrier: { description: @carrier.description, extension: @carrier.extension, name: @carrier.name } }
